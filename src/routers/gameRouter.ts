...
import { createAvaliation, deleteAvaliation, getAllAvaliations, getAllRate } from "../controllers/avaliationController";
...
//gameRouter.get("/game/mostrate", tokenValidator, getMostRated);
